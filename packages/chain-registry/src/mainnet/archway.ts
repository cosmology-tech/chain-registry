...
export const archway: Chain = {
  ...
  "codebase": {
    ...
    "binaries": {
      "linux/amd64": "https://github.com/archway-network/archway/releases/download/v6.0.2/archwayd_linux_amd64",
      "linux/arm64": "https://github.com/archway-network/archway/releases/download/v6.0.2/archwayd_linux_arm64",
      "darwin/amd64": "https://github.com/archway-network/archway/releases/download/v6.0.2/archwayd_darwin_amd64",
      "darwin/arm64": "https://github.com/archway-network/archway/releases/download/v6.0.2/archwayd_darwin_arm64"
    },
