...
export const jackal: Chain = {
  ...
  "codebase": {
    ...
    "binaries": {
      "linux/amd64": "https://github.com/JackalLabs/canine-chain/releases/download/v3.2.0/canined-Linux",
      "darwin/amd64": "https://github.com/JackalLabs/canine-chain/releases/download/v3.2.0/canined-macOS"
    },
    "genesis": {
