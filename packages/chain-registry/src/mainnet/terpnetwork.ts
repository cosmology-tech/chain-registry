...
export const terpnetwork: Chain = {
  ...
  "codebase": {
    ...
    "binaries": {
      "linux/amd64": "https://github.com/terpnetwork/terp-core/releases/download/v4.1.0/terpd-linux-amd64",
      "linux/arm64": "https://github.com/terpnetwork/terp-core/releases/download/v4.1.0/terpd-linux-arm64"
    },
    "versions": [
      {
        "name": "v1.0.0-stable",
