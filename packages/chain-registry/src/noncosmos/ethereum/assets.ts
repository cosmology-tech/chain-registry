...
const info: AssetList = {
  ...
  assets: [
    ...
    {
      description:
        'sDAI is a liquid representation of DAI deposited in the Dai savings rate contract.',
      type_asset: 'erc20',
    ...
    {
      description:
        'The OCC token acts as the fuel for the OccamRazer launchpad and it is indirectly used as well on the DAO governance layer.',
      type_asset: 'erc20',
    ...
    {
      description:
        'Gelotto blends gaming, DEFI, and fun Dapps in a unique Web3 ecosystem. Join us to become part of the house, earning from all Gelotto products. Our main goal? To bring the masses into Web3 with open, accessible, and enjoyable Dapps.',
      type_asset: 'erc20',
    ...
    {
      description:
        'BEAST: Battle, Breed, and Customize unique creatures powered by Ethereum & Cosmos',
    ...
    {
      description:
        'PUNDIX token is the native token that functions within the Pundi X ecosystem, including PundiX Chain and XPOS.',
      type_asset: 'erc20',
