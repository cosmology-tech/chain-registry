...
export const lavatestnet: Chain = {
  ...
  "codebase": {
    ...
    "recommended_version": "v0.21.1.2",
    "compatible_versions": [
      "v0.21.1.2"
    ],
    "binaries": {
      "linux/amd64": "https://github.com/lavanet/lava/releases/download/v0.21.1.2/lavad-v0.21.1.2-linux-amd64"
    },
...
export const lavatestnetAssetList: AssetList = {
