...
export const cosstestnet: Chain = {
  ...
  "peers": {
    "seeds": [
      {
        "id": "4bf62eb8e9d65bb86751529ca233df574891602f",
        "address": "35.72.222.149:26656",
        "provider": "COSS"
      }
    ],
    "persistent_peers": [
...
export const cosstestnetAssetList: AssetList = {
