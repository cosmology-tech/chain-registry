...
export const doravotatestnet2: Chain = {
  ...
  "codebase": {
    ...
    "binaries": {},
    "genesis": {
      "genesis_url": "https://github.com/DoraFactory/doravota/blob/main/config/incentive/genesis.json"
    },
    "versions": [
      {
        "name": "v9.0.1",
...
export const doravotatestnet2AssetList: AssetList = {
