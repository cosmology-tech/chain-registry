...
const assets: AssetList = {
  ...
  assets: [
    ...
    },
    {
      ...
      denom_units: [{
          denom: 'ibc/F64E7E43CAC1AEB502D028893DC4BD62D2CDFC55B7E21F23043DAE602B8A1F3E',
          exponent: 0,
          aliases: ['eth-wei']
        }, {
          denom: 'weth',
    ...
    },
    {
      ...
      denom_units: [{
          denom: 'ibc/3A8B6E50B8050FC8CD704CD48C7922EA221B5FDA672517E243DDFF603FF896ED',
          exponent: 0,
          aliases: ['wglmr-wei']
        }, {
          denom: 'wglmr',
    ...
    },
    {
      ...
      denom_units: [{
          denom: 'ibc/16F3EB18413FD15154B02F9929473A3C0A23902BF8044157E9E5E0FBEB24FCEE',
          exponent: 0,
          aliases: ['wmatic-wei']
        }, {
          denom: 'wmatic',
    ...
    },
    {
      ...
      denom_units: [{
          denom: 'ibc/D38FD4C586C397DDAAB715C654DAEE3C3C40462CD410254AC7576208E947605B',
          exponent: 0,
          aliases: ['wbnb-wei']
        }, {
          denom: 'wbnb',
    ...
    },
    {
      ...
      denom_units: [{
          denom: 'ibc/7186C4B1A0596A1AB34C201E27D659B4A9837B46A328BCE5C0E452CD7146BC8F',
          exponent: 0,
          aliases: ['wavax-wei']
        }, {
          denom: 'avax',
    ...
    },
    {
      ...
      denom_units: [{
          denom: 'ibc/F9E624EB89ABEE4CB1EC04D7941F613BD8383EE7DE323589A82066D0345EF6EB',
          exponent: 0,
          aliases: ['wftm-wei']
        }, {
          denom: 'ftm',
    ...
    },
    {
      ...
      denom_units: [{
          denom: 'ibc/CD2487F7C3C44914D572111D462A529FD8E699F2123B976F40168452B41BB5D8',
          exponent: 0,
    ...
    },
    {
      type_asset: 'sdk.coin',
      denom_units: [{
          denom: 'ibc/76F99708DB7035A8774A644BFFD9B9736272970A7DF17397C7E35F7DBBCFE802',
          exponent: 0,
    ...
    },
    {
      ...
      denom_units: [{
          denom: 'ibc/70DF86A0367EE67FB3726F370360CB27788D844B1669B7953044BDA2D78FB7EA',
          exponent: 0,
          aliases: ['uusdc']
        }, {
          denom: 'usdc',
    ...
    },
    {
      ...
      denom_units: [{
          denom: 'ibc/46F35358D7836AEEA635174D70AAAEBF8686D1506DF15017CF453A79ADB4C251',
          exponent: 0,
          aliases: ['uusdlr']
        }, {
          denom: 'usdlr',
