...
const assets: AssetList = {
  ...
  assets: [
    ...
    },
    {
      ...
      denom_units: [{
          denom: 'ibc/75C575824692FA642ED57B7B5CB1C11807E8B5D80027095DDA724DC98C6C018A',
          exponent: 0,
          aliases: ['eth-wei']
        }, {
          denom: 'weth',
    ...
    {
      denom_units: [{
          denom: 'ibc/AB2FB1E06C1D202211CC6C1871FD9467F56887396562EE39456C123DC6BCC2FB',
          exponent: 0,
    ...
    },
    {
      ...
      denom_units: [
        {
          denom: 'ibc/189B2C50BD4514595544694AA7D267DA509D1085F4C29ABC1A03F484DAC1C792',
          exponent: 0,
    ...
    },
    {
      description: 'Circle\'s stablecoin on Axelar',
      denom_units: [{
          denom: 'ibc/3991F1E282275087A3E633977100736376EE72EE6B65BF2EE5BDA13BFFAD8F02',
          exponent: 0,
