  ...
  codebase: {
    ...
    versions: [
      ...
      },
      {
        ...
        nextVersionName: 'v2.54.0'
      },
      {
        name: 'v2.54.0',
        proposal: 383,
        height: 64775201,
        recommendedVersion: 'v2.54.0',
        compatibleVersions: ['v2.54.0'],
        binaries: {
          "linux/amd64": 'https://github.com/Switcheo/carbon-bootstrap/releases/download/v2.54.0/carbond-mainnet.linux-amd64.tar.gz',
          "linux/arm64": 'https://github.com/Switcheo/carbon-bootstrap/releases/download/v2.54.0/carbond-mainnet.linux-arm64.tar.gz'
        },
        nextVersionName: ''
      }
    ]
